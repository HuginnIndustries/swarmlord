# GUIDE — SwarmLord codebase

> **Note**: This file inherits packet-progression content from the originating packet. It will be rewritten as a code-development guide during V1 implementation. Until then, the primary entry point is [`AGENTS.md`](AGENTS.md).

## Inherited packet-progression content

The text below describes how a project *packet* moves through stages. It's preserved here as reference for implementing SwarmLord's stage and phase logic, not as guidance for working on the codebase itself.
...
| --- | --- | --- |
| Instructions | `GUIDE.md`, `workflow/pipeline.yaml`, `skills/*/SKILL.md` | Read first. Edit only to improve this packet's local workflow. |
